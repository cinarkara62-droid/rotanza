    ...
    <div className="relative z-10 mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto mt-10 max-w-2xl overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white via-white to-brand-50/60 p-6 shadow-sm">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-sm font-semibold text-foreground">{isTr ? "Rota ara" : "Search a route"}</h3>
        </div>
        ...
        >
          ...
          <button
            ...
            className="shrink-0 rounded-full border border-white/15 bg-sand-100 px-5 py-2 text-sm font-semibold text-foreground transition-colors hover:border-brand-300"
          >
          ...
          {transport && !customCity && (
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-sand-100 p-6 shadow-sm">
                <h3 className="text-sm font-semibold text-foreground">{dict.transport.tipsTitle}</h3>
                <ul className="mt-3 space-y-2.5">
                  {(isTr ? transport.tipsTr : transport.tipsEn).map((tip) => (
                    <li key={tip} className="flex gap-2 text-sm leading-relaxed text-foreground/60">
              ...
              <div className="rounded-2xl border border-white/10 bg-sand-100 p-6 shadow-sm">
                <h3 className="text-sm font-semibold text-foreground">{dict.transport.ticketTitle}</h3>
